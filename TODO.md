...
- [ ] **R3 (`NEXT`) Record separate D-079 acceptance after integration review.** The [Gate B left-successor substitution contract](docs/plans/D079-LEFT-SUCCESSOR-SUBSTITUTION.md) was frozen at `a8fe21e12b2d036e8ec22f10e25c4d07a5374f6f`; reviewed implementation is committed at `080fe0e209af26bcd11d64befe392510860835f5`. Readiness review `e4bfb40c-1cd5-4389-b986-e2c3a18e8e24` passed after complete semantic review and both supported-compiler, boundary, oracle, archive and warning-enabled Haddock checks. Integration and a separate reviewed acceptance-status edit remain required. Keep callbacks, RCP, point conditioning and multi-step control excluded; D-079 remains `Proposed`.
