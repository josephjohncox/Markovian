...
Mathematics uses the pinned local MathJax 3.2.2 SVG bundle under `theme/vendor/mathjax`; the built book does not require a MathJax CDN request. The book check verifies the bundle digest and every generated display block.
