...
Checked output (regenerated by `python3 scripts/check-learning --write`):

```text
{{#include ../../learning/sample-output.txt}}
```
...
Check the terminal/horizon contrast in [laboratory D](law-laboratory.md#d-terminal-and-horizon-timing),
then follow the [MDP practice route](learning-routes.md#route-1-mdp-practice).
