...
data ClarkScarfSolution = ClarkScarfSolution
    ...
    -- ^ The clark scarf solution fixture.
    , clarkScarfStateChecks :: !(NonEmpty.NonEmpty ClarkScarfStateCheck)
    -- ^ The clark scarf state checks.
...
-- | Return the clark scarf initial regret.
...
-- | Compare the clark scarf bounds.
