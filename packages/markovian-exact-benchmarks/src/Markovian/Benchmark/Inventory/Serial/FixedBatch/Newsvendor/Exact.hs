...
-- | Return the shortfall expected b 0.
...
-- | Return the shortfall no stockout probability.
...
-- | Return the shortfall b 1 zero probability.
...
-- | Return the subsystem 1 forward difference.
...
-- | Return the subsystem 2 forward difference.
...
-- | Return the subsystem 1 inequality.
...
-- | Return the subsystem 2 inequality.
...
data NewsvendorDomain = NewsvendorDomain
    ...
    -- ^ The newsvendor r 1 layout.
    , newsvendorR2Layout :: !(NonEmpty Integer)
    -- ^ The newsvendor r 2 layout.
    }
    deriving (Eq, Show)
